...
void Render()
{
	...
	vertices.push_back(Vertex(Vector3f(0, 0, 0), Color(0, colorValue, 0, 255)));
	vertices.push_back(Vertex(Vector3f(1.0f, 0, 0), Color(0, colorValue, 0, 255)));
	vertices.push_back(Vertex(Vector3f(0.5f, 1.0f, 0), Color(0, colorValue, 0, 255)));
	renderer.drawTriangleStrip(vertices);
